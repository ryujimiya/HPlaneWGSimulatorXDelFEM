    ...
    /*public*/ partial class CalcSettingFrm : Form
    {
            ...
            double waveguideWidthForEPlane)
        {
            ...
            ElemShapeStruct[] esList =
            {
                ...
                //new ElemShapeStruct(Constants.FemElementShapeDV.QuadType2, Constants.SecondOrder, "２次四角形要素"),  //DelFEMでは四角形メッシュは非対応
                new ElemShapeStruct(Constants.FemElementShapeDV.Triangle, Constants.FirstOrder, "１次三角形要素"),
                //new ElemShapeStruct(Constants.FemElementShapeDV.QuadType2, Constants.FirstOrder, "１次四角形要素"),  //DelFEMでは四角形メッシュは非対応
            };
