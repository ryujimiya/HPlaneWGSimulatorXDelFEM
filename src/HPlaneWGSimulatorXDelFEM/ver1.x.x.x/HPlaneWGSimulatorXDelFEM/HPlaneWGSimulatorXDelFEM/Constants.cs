...
namespace HPlaneWGSimulatorXDelFEM
{
    class Constants
    {
        ...
        /// <summary>
        /// DelFEM CadObj2Dファイル拡張子
        /// </summary>
        public static readonly string CadObjExt = ".cadobj";
        /// <summary>
        /// Fem入力データファイル拡張子
        /// </summary>
        ...
        /// </summary>
        //public const double MesherElementLength = 1.5;
        public const double MesherElementLength = 1.25;
        //public const double MesherElementLength = 1.0;
        /// <summary>
        /// 界分布表示における三角形要素内の分割数
        /// </summary>
        //public const int TriDrawFieldMshDivCnt = 4;
        public const int TriDrawFieldMshDivCnt = 6;  // DelFEMでは三角形が直角三角形でないため、分割数を多くとらないとスムーズな分布にならなかった
